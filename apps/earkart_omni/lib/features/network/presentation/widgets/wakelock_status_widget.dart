      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            color:
                isEnabled
                    ? Colors.amber.shade50.withOpacity(_pulseAnimation.value)
                    : Colors.grey.shade50,
            borderRadius: BorderRadius.circular(10),
            border: Border.all(
              color:
                  isEnabled
                      ? Colors.amber.shade300.withOpacity(_pulseAnimation.value)
          ...
          child: Center(
            child: Icon(
              ...
              color:
                  isEnabled
                      ? Colors.amber.shade700.withOpacity(_pulseAnimation.value)
