// app/dashboard/reports/audiologist/page.tsx
"use client";
...
export default function AudiologistMetricsPage() {
  ...
  return (
    <DashboardBodyWrapper pageTitle="🩺 Audiologist Analytics Dashboard" button={FilterButton}>
      <div className="space-y-6">
        ...
        {!isLoading && !isError && data && (
          <div className="space-y-6">
            ...
            <Card className="shadow-lg">
              <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white">
                <CardTitle>🩺 Audiologist Data Points</CardTitle>
              </CardHeader>
            ...
            {/* Enhanced Metadata */}
            <Card className="bg-gradient-to-r from-gray-50 to-purple-50 border-2 border-purple-200">
              <CardHeader>
          ...
          <Card className="border-2 border-dashed border-gray-300 bg-gray-50">
            <CardContent className="pt-12 pb-12">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">No audiologist data found</h3>
