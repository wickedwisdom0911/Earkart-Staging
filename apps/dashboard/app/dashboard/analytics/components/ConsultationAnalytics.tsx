...
const LoadingSpinner = () => (
  <div className="flex flex-col items-center justify-center h-64 space-y-4">
    ...
    <div className="text-center">
      <p className="text-lg font-medium text-gray-700">Loading consultation metrics...</p>
...
export default function ConsultationAnalytics({ userRole, currentUser }: ConsultationAnalyticsProps) {
  ...
  // Show consultation data if user has access
  const hasConsultationData = isHeadAudiologist ? consultationsByAudiologist.data : null;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Consultation Analytics</h3>
          <p className="text-sm text-gray-500">View consultation metrics and trends</p>
        </div>
        {FilterButton}
      </div>
      ...
      {!isLoading && !isError && data && (
        <div className="space-y-6">
          ...
          <Card className="shadow-lg">
            <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white">
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Consultation Metrics Over Time</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
          ...
          <Card className="shadow-lg">
            <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white">
              <CardTitle>📊 Consultation Data Points</CardTitle>
            </CardHeader>
